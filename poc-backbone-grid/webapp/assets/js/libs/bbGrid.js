...
_.extend(bbGrid.View.prototype, Backbone.View.prototype, {
    ...
    render: function () {
        ...
        if (!this.$navBar) {
            ...
            this.$loading = $('<div class="bbGrid-loading progress progress-info progress-striped active"><div class="bar bbGrid-loading-progress">Loading..</div></div>');
    ...
    initPager: function () {
        ...
        var pager = _.template('<div class="span bbGrid-pager">\
            <ul class="nav nav-pills">\
                ...
                <li>\
                    <div class="bbGrid-page-counter pull-left">Page</div>\
                    <input class="bbGrid-page-input" value="<%=page%>" type="text">\
                    <div class="bbGrid-page-counter-right pull-right"> of <%=cntpages%> </div>\
                </li>\
            ...
            <% if (rowlist) {%>\
                <div class="bbGrid-pager-rowlist-label pull-left">Page Size</div>\
